...
#ifndef DISPATCHER_BASE_TASK_DISPATCHERBASETASK_HPP
#define DISPATCHER_BASE_TASK_DISPATCHERBASETASK_HPP
...
namespace dispatcher_base {
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','dispatcher_base::DispatcherBaseTask')
     end
     \endverbatim
     *  It can be dynamically adapted when the deployment is called with a prefix argument. 
     */
    template <typename T>
    class DispatcherBaseTask : public TaskBase
    {
    ...
    public:
        /** TaskContext constructor for DispatcherBaseTask
         * \param name Name of the task. This name needs to be unique to make it identifiable via nameservices.
         * \param initial_state The initial TaskState of the TaskContext. Default is Stopped state.
         */
        DispatcherBaseTask(std::string const& name = "dispatcher_base::Task");
         ...
         * 
         */
        DispatcherBaseTask(std::string const& name, RTT::ExecutionEngine* engine);
